...
class BaseStudentItemViewSet(viewsets.ModelViewSet):
    """Base ViewSet that restricts access to the student's own items."""
    permission_classes = [permissions.IsAuthenticated, IsStudentOwnerOrReadOnly]
...
from apps.students.serializers import (
    InternshipSerializer, ProjectSerializer, CertificationSerializer,
    EventSerializer, ResearchSerializer, CourseSerializer,
    EducationBackgroundSerializer, SemesterResultSerializer
)

class InternshipViewSet(BaseStudentItemViewSet):
    queryset = Internship.objects.all()
    serializer_class = InternshipSerializer

class ProjectViewSet(BaseStudentItemViewSet):
    queryset = Project.objects.all()
    serializer_class = ProjectSerializer

class CertificationViewSet(BaseStudentItemViewSet):
    queryset = Certification.objects.all()
    serializer_class = CertificationSerializer

class EventViewSet(BaseStudentItemViewSet):
    queryset = Event.objects.all()
    serializer_class = EventSerializer

class ResearchViewSet(BaseStudentItemViewSet):
    queryset = Research.objects.all()
    serializer_class = ResearchSerializer

class CourseViewSet(BaseStudentItemViewSet):
    queryset = Course.objects.all()
    serializer_class = CourseSerializer

class EducationBackgroundViewSet(BaseStudentItemViewSet):
    queryset = EducationBackground.objects.all()
    serializer_class = EducationBackgroundSerializer

class SemesterResultViewSet(BaseStudentItemViewSet):
...
class StudentPortalView(LoginRequiredMixin, View):
    ...
    def get(self, request, **kwargs):
        ...
        return render(request, 'student_portal/base_portal.html', {
            'profile': profile,

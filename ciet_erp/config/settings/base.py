...
# Monkey-patch built-in apps to use ObjectIdAutoField instead of AutoField
try:
...
STATICFILES_DIRS = [
    BASE_DIR / "static",
    BASE_DIR / "templates" / "student_portal" / "dist",
]
...
DJANGO_VITE = {
    "default": {
        ...
        "manifest_path": BASE_DIR / "templates" / "student_portal" / "dist" / ".vite" / "manifest.json",
    }
}
